...
# Modal-specific
MAX_RUNTIME_MINUTES = 50          # Stop à 50min (10min pour upload + swap)
CHECKPOINT_EVERY_MINUTES = 45     # Sauvegarder à 45min (safe margin)
...
CONFIG = {
    ...
    'validate_every_steps': 1000,  # ↓ moins de validation
    'val_batches':          20,    # ↓ validation rapide
...
print("=" * 80)
print("🔥 HessGPT Mini 0.28B — PRETRAIN (MODAL)")
