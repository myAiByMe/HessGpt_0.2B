...
class SFTDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # ✅ FIX #2: Smart masking - ne masque que prompt/context, pas assistant response
        ...
        if 'messages' in sample:
            ...
            for msg in sample['messages']:
                ...
                if role == 'system':
                    ...
                    # ✅ FIX #1: Proper JSON format for tool_calls
                    ...
                    if tool_calls:
                        for tc in tool_calls:
                            ...
                            # Parse arguments (peut être string ou dict)
...
# ✅ FIX #3: Function calling validation
import json
import re
...
class FunctionCallingValidator:
    ...
    def validate(self, num_samples=10):
        """Générer et valider function calls"""
        self.model.eval()
...
# ✅ FIX #4: Validateur pour checker function calling pendant training
...
for epoch in range(EPOCHS):
    ...
    # ✅ FIX #4: Validation après chaque epoch
    print(f"\n   🔍 Validating function calling...")
    val_results = validator.validate(num_samples=20)
    print(f"   ✅ Tool calls generated: {val_results['total']} | Valid: {val_results['valid']} ({100*val_results['rate']:.0f}%)")
